...
FADE_FROM= 500.0    # الصف الذي يبدأ عنده خفوت الحبر (بإحداثيات الصورة)
FADE_TO  = 528.0    # الصف الذي يكتمل عنده الانتقال إلى قياس الخفوت
TAIL_END = 552.0    # آخر صف فيه حبر حقيقي
